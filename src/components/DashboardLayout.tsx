...
const AppSidebar = () => {
  ...
  return (
    <Sidebar collapsible="icon" className={open ? "w-64" : "w-[68px]"}>
      <SidebarContent className="bg-sidebar border-r border-sidebar-border">
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu className="p-2 space-y-1">
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="bg-sidebar-accent text-sidebar-accent-foreground hover:bg-accent hover:text-accent-foreground active:bg-accent active:text-accent-foreground">
                  <a href="/" className={`flex items-center gap-3 py-3 ${!open ? 'justify-center px-0' : 'px-3'}`}>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild className="hover:bg-accent hover:text-accent-foreground active:bg-accent active:text-accent-foreground">
                  <a href="#" className={`flex items-center gap-3 py-3 ${!open ? 'justify-center px-0' : 'px-3'}`}>
        ...
        <div className="mt-auto p-3 border-t border-sidebar-border">
          <div className={`py-2.5 rounded-lg bg-sidebar-accent/50 ${!open ? 'flex justify-center px-0' : 'px-3'}`}>
